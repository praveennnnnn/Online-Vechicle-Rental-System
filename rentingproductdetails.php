        ...
        <div class="small-container">
            <div class="row">
                    <?php
                     require 'init.php';
                     $ID=$_GET["userid"];
                     $sql= "SELECT * FROM renting WHERE id ='$ID'";
                    ...
                    <div class="col2" >
                             ...
                             <h3> Price: </h3> <h4><?php echo $row['price']; ?> </h4><br>
                             <h3> Pickup Point: </h3><h4> <?php echo $row['pick_loc']; ?></h4> <br>
                             <h3> Maximum renitng Days: </h3><h4> <?php echo $row['rentdays']; ?></h4> <br>
                             <h3> Product Description <i class="fa fa-indent" ></i></h3><br><p><?php echo $row['pdescription']; ?></p><br> 
