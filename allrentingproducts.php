...
<!DOCTYPE html>
 <html>
     <head>
         ...
         <title> Products available For Rent - RentingInn </title>
...
<div class="small-container">
         <div class="row row-2">
            <div class="col22">
               <h3 style="font-size: 20px;">Products For Rent </h3>   
            </div>
                  <div class="col22" >            
                 <form action="rentsearchname.php" method="GET">
                     <input type="text" name="searchbyname" placeholder=" Search Product by Name" autocomplete="off" required style="width: 300px;height: 40px;text-align: center;font-size: 20px; border-radius: 30px;border-color: #ff1a1a; background: transparent;"  >
            ...
            <div class="col22">
                 <form action="rentsearchloc.php" method="GET">
                     <input type="text" name="rentlocsearch" placeholder=" Search by City Name " autocomplete="off" required style="width: 400px;height: 40px;text-align: center;font-size: 20px; border-radius: 30px;border-color: #ff1a1a; background: transparent;"  >
     ...
     <div class="small-container">
        <!--- <div class="row">--->   
            <div class="row">
             ...
             ?>
         <div class="col4" >
             <a href="rentingproductdetails.php?userid= <?php echo $row['id']; ?>" >
                 <img src="<?php echo $f_img; ?>" style="width: 200px;height: 200px;">
                 <h3 style="color: #000000;"> <?php echo $row['name']; ?></h3>
                 <h3 style="color: #000000;"> Price: </h3> <h4><?php echo $row['price']; ?> </h4><br></a>

                 <button type="submit" name="add" class="btn"  style="margin-top: 0px;"><a style="color: #ffff;" href="rentingproductdetails.php?userid= <?php echo $row['id']; ?>">  Product Details <i class="fa fa-info-circle" ></i>
                 </a>
             </button>
