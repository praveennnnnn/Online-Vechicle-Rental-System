         ...
         <div class="container">  <!--contanier class div starts-->
             ...
             <div class="logo">
                 ...
                 <form action="rentsearchname.php" method="GET">
                     <input type="text" name="searchbyname" placeholder=" Search Product by Name" autocomplete="off" required style="width: 500px;height: 40px;text-align: center;font-size: 20px; border-radius: 30px;border-color: #ff1a1a; background: transparent;"  >
             ...
             <div class="col22">
                 <form action="rentsearchloc.php" method="GET">
                     <input type="text" name="rentlocsearch" placeholder=" Search Product by City" autocomplete="off" required style="width: 500px;height: 40px;text-align: center;font-size: 20px; border-radius: 30px;border-color: #ff1a1a; background: transparent;"  >
                 ...
                 <div class="row">   <!---products row start-->
                    <?php
                     ...
                     $sql= "SELECT * FROM renting  WHERE name  LIkE '%$searchbyname%' "; 
             ...
             <a href="rentingproductdetails.php?userid= <?php echo $row['id']; ?>">
                 ...
                 <h2 style="color: #000000;"> <?php echo $row['name']; ?></h2>
                 <h3 style="color: #000000;"> Price: </h3> <h4><?php echo $row['price']; ?> </h4><br>
                 <button type="submit" name="add" class="btn" style="margin-top: 2px;"> Product Details <i class="fa fa-info-circle" ></i></button>
             </a>
         </div>
                     <?php  
                             }
